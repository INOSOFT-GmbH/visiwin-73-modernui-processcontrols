    ...
    public class ProcessControlBaseInitializer : DefaultInitializer
    {
        ...
        public override void InitializeDefaults(ModelItem item)
        {
            ...
            try
            {
                ...
                item.Properties[new PropertyIdentifier(typeof(ProcessControlBase), nameof(ProcessControlBase.StateBrushes))]
                ...
                item.Properties[new PropertyIdentifier(typeof(ProcessControlBase), nameof(ProcessControlBase.Mapping))]
